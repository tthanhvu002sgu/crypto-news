...
export const MODULES_CONFIG = {
  ...
  hft_advanced_chart: { id: 'hft_advanced_chart', label: 'Advanced Price Action: POC & Walls', category: 'Order Flow' },
  hft_heatmap: { id: 'hft_heatmap', label: 'Advanced Price Action: POC & Walls', category: 'Order Flow' },
